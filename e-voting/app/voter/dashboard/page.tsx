...
export default function VoterDashboard() {
  ...
  const handleVote = async (candidateId: number) => {
    try {
      ...
      console.log("Sending parameters:", BigInt(candidateId-28), BigInt(hashedId), a, b, c, input)

      // Call the smart contract with the actual selected candidate index
      const tx = await contract.vote(BigInt(candidateId-28), BigInt(hashedId), a, b, c, input)
